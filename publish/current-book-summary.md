...
最新新增的强制约束也已经落盘：后续所有章节都必须严格遵守版本边界，禁止把高版本内容提前写进低版本章节。
此外，现有第 1 章至第 7 章已经开始按这套规则回修：正文中出现版本号时，必须同步给出可查阅的版本资料索引；已经越界的章节内容则先回修边界，再继续扩写。
...
| `publish/drafts/ch06/ch06.md` | 已形成正式正文 | 继续精修工具边界、MCP 协议与验证链路 |
| `publish/drafts/ch07/ch07.md` | 已形成正式正文初稿 | 继续补图示导出、PDF 样张与章节锚点稳定化 |
...
5. 精修第 6 章的工具边界正文、术语与验证链路。
6. 为第 7 章补统一图示导出、PDF 样张与章节锚点稳定化。
7. 继续检查前 7 章是否仍残留“低版本章节混入高版本结构”的问题。
...
1. 先恢复结构，再进入正文。
2. 每章都要建立章节锚点，绑定版本、正式标签或预留标签、代码入口和验证命令。
...
6. 每章必须明确绑定一个版本或一段连续版本区间。
7. 低版本章节如果混入高版本结构，必须先回修边界，再继续扩写。
8. 正文如果出现明确版本号，必须同步给出 `publish/version-index.md`、对应版本文档或稳定标签中的至少一种确定索引。
